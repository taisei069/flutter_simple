...
class StProblemEasyQuake1 extends StatefulWidget {
  const StProblemEasyQuake1({super.key});

  @override
  State<StProblemEasyQuake1> createState() => _StProblemEasyQuake1State();
}

class _StProblemEasyQuake1State extends State<StProblemEasyQuake1> {
          ...
          Padding(
            ...
            child: ElevatedButton(
              onPressed: isAllAnswered
                  ? () {
                      context.push('/st_problem_easy_quake_answer', extra: {
                        'userAnswers': answers,
